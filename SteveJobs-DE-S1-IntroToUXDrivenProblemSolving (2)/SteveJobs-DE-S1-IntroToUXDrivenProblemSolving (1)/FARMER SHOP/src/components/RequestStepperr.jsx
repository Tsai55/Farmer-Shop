...
export default function RequestStepperr({onSubmit}) {
    ...
    return (
        ...
        <Stepper submitBtn={<Button onClick={submit} className="defaultBtn">Submit</Button>}>
            ...
            <div className="stepper-form">
                <div className="my-4">
                    <h6>Quantity</h6>
                    <input placeholder="Number of Products " name="fare" onChange={valueOnChange} className="w-100" type="number" defaultValue={values.fare} id="Quantity" />
                </div>
                <div className="row justify-content-center mt-4">
                    <img alt="" src={'https://th.bing.com/th/id/OIP.skZFydohJYZ-lgGuyJuJNAHaEQ?rs=1&pid=ImgDetMain'} style={{ height: '200px', objectFit: 'contain' }} />
                </div>
            </div>
            ...
            {/* <div className="stepper-form">
                <div className="my-4">
                    <h6>Quantity</h6>
                    <input placeholder="text" name="Quantity" onChange={valueOnChange} className="text" type="text" defaultValue={values.time} id="date" />
                </div>
                <div className="row justify-content-center mt-4">
