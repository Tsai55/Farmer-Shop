        ...
        <header className="page-header mt-0 position-fixed">
            ...
            <div className="d-flex justify-content-between w-100 align-items-center">
                ...
                <div className="d-flex">
                    ...
                    <img
                        src="https://th.bing.com/th/id/OIP.1DLy-IgWRP1cO-e8lLMKEQHaH_?rs=1&pid=ImgDetMain"
                    ...
                    <div className="ml-2 my-auto">
                        ...
                        <span className="header-text1 mx-2 text-uppercase">FARMER</span>

                        {/* Step 3.2.1.4: Second line of text */}
                        <span className="header-text2 text-uppercase">SHOP</span>
                    </div>
                </div>
            </div>
