...
export default function User(props) {
    ...
    const dataOnSubmit = async (data) => {
        ...
        setRequestt((previousData) => ([data, ...previousData]));
        ...
        <>
            ...
            <div className="px-4 mt-5 background">
                <div className="row mt-5 justify-content-center">
                    ...
                    <h1 className="pt-5 text-center">Supplier Details</h1>
                </div>

                {/* Step 9.3: Slider component for displaying requestt */}
                <Slider {...settings}>
                    {requestt.map((item, index) => <RequestCard data={item} image={getImageBasedOnRequirement(item.requirement)} key={index} />)}
                </Slider>
            </div>
            ...
            <Dialog maxWidth="sm" fullWidth open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    {/* Step 9.5.3.1: RequestStepperr component for user input */}
                    <RequestStepperr onSubmit={dataOnSubmit} />
                </DialogContent>
            </Dialog>
